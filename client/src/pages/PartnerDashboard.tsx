  ...
  const getStatsCards = () => [
    {
      ...
      value: formatWithPyg(partner?.totalEarnings || "0", exchangeRate),
      icon: DollarSign,
                      ...
                      {referrals.map((referral) => (
                        <TableRow key={referral.id} data-testid={`referral-row-${referral.id}`}>
                          ...
                          <TableCell className="font-medium text-foreground text-sm">
                            {formatWithPyg(referral.projectPrice || "0", exchangeRate)}
                          </TableCell>
                          <TableCell className="font-bold text-primary text-sm">
                            {formatWithPyg(referral.commissionAmount || "0", exchangeRate)}
                          </TableCell>
