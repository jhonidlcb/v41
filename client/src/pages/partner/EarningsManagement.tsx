      ...
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          <Card>
            ...
            <CardContent>
              <div className="text-xl font-bold">{formatWithPyg(totalEarnings, exchangeRate)}</div>
          ...
          <Card>
            ...
            <CardContent>
              <div className="text-xl font-bold">{formatWithPyg(pendingCommissions, exchangeRate)}</div>
                    ...
                    {recentReferrals.slice(0, 3).map((referral) => (
                      <div key={referral.id} className="flex items-center justify-between">
                        ...
                        <div className="text-right">
                          <p className="font-medium text-sm">{formatWithPyg(referral.commission, exchangeRate)}</p>
                  ...
                  <div className="space-y-4">
                    {commissionHistory.slice(0, 3).map((commission) => (
                      <div key={commission.id} className="flex items-center justify-between">
                        ...
                        <div className="text-right">
                          <p className="font-medium text-sm">{formatWithPyg(commission.amount, exchangeRate)}</p>
                    ...
                    <div key={referral.id} className="border rounded-lg p-4">
                      ...
                      <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-sm">
                        ...
                        <div>
                          ...
                          <p className="font-medium text-sm">{formatWithPyg(referral.projectValue, exchangeRate)}</p>
                        </div>
                        <div>
                          <p className="text-muted-foreground">Tu Comisión</p>
                          <p className="font-medium text-green-600 text-sm">{formatWithPyg(referral.commission, exchangeRate)}</p>
                        </div>
                      </div>
                    </div>
                  ))}
                    ...
                    <div key={commission.id} className="border rounded-lg p-4">
                      ...
                      <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-sm">
                        <div>
                          ...
                          <p className="font-medium text-green-600 text-sm">{formatWithPyg(commission.amount, exchangeRate)}</p>
                        </div>
                        <div>
