...
import { formatWithPyg, convertUsdToPyg, type ExchangeRate } from "@/lib/currency";
import {
  BarChart,
  Bar,
  XAxis,
                ...
                <CardContent>
                  <ResponsiveContainer width="100%" height={300}>
                    <AreaChart data={analyticsData.revenue.chart}>
                      ...
                      <XAxis dataKey="month" />
                      <YAxis />
                      <Tooltip formatter={(value) => [formatWithPyg(value as number, exchangeRate), "Ingresos"]} />
                ...
                <CardContent>
                  <ResponsiveContainer width="100%" height={300}>
                    <BarChart data={analyticsData.partners.earnings}>
                      ...
                      <YAxis />
                      <Tooltip formatter={(value) => [formatWithPyg(value as number, exchangeRate), "Ganancias"]} />
